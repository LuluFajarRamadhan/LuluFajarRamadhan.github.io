---
title: Ringkasan Barisan dan Deret SMA
---
...
- **Pertumbuhan (Sains/Demografi):** $M_n = M_0(1 + i)^n$
- **Peluruhan (Penyusutan Aset/Radioaktif):** $M_n = M_0(1 - i)^n$
...
- **Notasi Sigma:** $\sum_{k=1}^{n} U_k = U_1 + U_2 + \dots + U_n$
- **Prinsip Induksi Matematika:** 1. Buktikan benar untuk $n = 1$.
