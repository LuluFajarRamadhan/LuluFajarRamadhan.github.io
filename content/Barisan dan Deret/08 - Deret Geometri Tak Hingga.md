...
$$
✮\boxed{\text{Total Lintasan} = H \cdot \left( \frac{q + p}{q - p} \right)}
$$
...
>$$
>S_{\infty \text{ (turun)}} + S_{\infty \text{ (naik)}} = 48 + 36 = 84\text{ meter}
>$$
> 
...
> \text{Total Lintasan} &= 12 \cdot \left( \frac{4 + 3}{4 - 3} \right) \\
> \text{Total Lintasan} &= 12 \cdot \left( \frac{7}{1} \right) = 84\text{ meter}
> \end{aligned}
> $$
> 
